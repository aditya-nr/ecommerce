...
const SellerLogin = () => {
    ...
    const setLogin = useSeller(s => s.login);
        ...
        <>
            ...
            <div className='flex w-[60%] mx-auto mt-10 h-[80vh] rounded-md bg-white drop-shadow-lg'>
                ...
                <div className='text-gray-700 w-[40%] bg-blue-100 p-10 relative'>
                    ...
                    <p className='text-lg my-4'>Your Products, Our Shop.
                        <br /> Sell you product like never before.</p>
                    <img src="/yat.svg" alt="JustBuy" className='absolute bottom-2 left-0 p-6' />
                </div>
                {/* Login Page */}
                <div className='flex-1 flex flex-col justify-center items-center '>
                    ...
                    {/* footer */}
                    <div className='mt-2'>
                        Don't have seller account? <Link to={'/seller-register'} className='font-semibold text-blue-500 cursor-pointer'>Create One</Link>
                    </div>
                </div>
            </div>
        </>
