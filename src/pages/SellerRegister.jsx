        ...
        <>
            ...
            <div className='flex w-[60%] mx-auto mt-10 h-[80vh] rounded-md bg-white drop-shadow-lg'>
                ...
                <div className='text-gray-700 w-[40%] bg-blue-100 p-10 relative'>
                    ...
                    <p className='text-lg my-4'>Sign up with your email to get started selling</p>
                    <img src="/yat.svg" alt="JustBuy" className='absolute bottom-0 left-0 p-6' />
                </div>
                {/* form */}
                <div className='flex-1 flex flex-col justify-center items-center '>
                    ...
                    {/* footer */}
                    <div className='mt-2'>
                        Existing User? <Link to={'/seller-login'} className='font-semibold text-blue-500 cursor-pointer'>Log in</Link>
                    </div>
                </div>
            </div>
        </>
